    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <p className="text-gray-800 text-lg mb-8 leading-relaxed">
          "Unlock the Competitive Edge with Our Exceptional 3PL <br /> Services –
          Discover a World of Streamlined Operations,<br /> Optimal Efficiency, and
          End-to-End Supply Chain Solutions <br /> Tailored to Your Unique Business
          Needs!"
        </p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  We deliver our services to the very best work, whether as an
                  external provider.
                </p>
              </div>
            </div>
