    ...
    <>
      <section className="relative h-[200px] sm:h-[200px] lg:h-[300px] flex items-center justify-center text-white">
        ...
        <div
          ...
          role="img" aria-label="Service background image"  // Added alt text for accessibility
        ></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
          ...
          <div className="flex items-center text-gray-300 text-sm">
            <Link to="/" className="hover:text-white transition-colors" aria-label="Go to Home page">
              Home
            </Link>
